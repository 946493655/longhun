...
INSERT INTO `admin` VALUES (1,'九哥','九哥',1,'$2y$10$GsKQodaitpN99f/k4MgCA.E/nLU3e3Ip23T.Pau4jtZR5/QnCStYK','a12345',1469246071,1469256089,1470009681);
...
CREATE TABLE `admin_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='管理员日志表 admin_log';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `admin_log` VALUES (1,1,1469262166,1469262803),(2,1,1469262813,1469262973),(3,1,1469262977,0),(4,1,1469845173,0),(5,1,1469856359,0),(6,1,1469933409,0),(7,1,1470009681,0);
...
INSERT INTO `farms` VALUES (1,1,1,4.00,'备注：7.15+龙魂·九哥',1,'',3,'完美香氛',220.00,0,8,0,1469939152,0),(2,1,1,4.00,'备注：7.15+龙魂·九哥',1,'',3,'衣尘不变',75.00,0,8,0,1469939413,0),(3,1,1,3.50,'备注：7.16+zwx946493655',1,'',4,'吉祥轮胎批发',430.00,0,8,0,1469954604,0),(4,1,1,6.00,'备注：待收货，好评，到账',1,'',5,'如云宠物用品专营店',79.00,0,8,0,1469955182,0),(5,1,1,3.50,'到账',1,'',6,'西安九鼎门窗店',75.00,0,8,0,1469955556,0),(6,1,1,4.00,'备注：到账',1,'',7,'文章代写工作室',10.00,0,8,0,1469955625,0),(7,1,1,3.50,'备注：到账',1,'',8,'恒寿祥集团官方企业店',2799.00,0,8,0,1469955666,0),(8,1,1,3.50,'备注：到账',1,'',8,'上海海扬气模直销店',240.00,0,8,0,1469955701,0),(9,1,1,4.00,'备注：到账',1,'',9,'文博钢木家具',382.50,0,8,0,1469955761,0),(10,1,1,3.50,'备注：礼物，到账，10字好评',1,'',8,'纸器时代品牌折扣店',69.52,0,8,0,1469955839,0),(11,1,1,4.00,'备注：到账，10字好评',1,'',10,'苏泊尔炊具精品店',168.00,0,8,0,1469957197,0),(12,1,1,3.00,'...',1,'',11,'凯路菲斯',59.00,0,8,0,1469957240,0),(13,1,1,3.00,'...',1,'',11,'生活构造品牌女包',138.00,0,8,0,1469957279,0),(14,1,1,4.00,'备注：到账，20字好评',1,'',2,'中蝶玩具城',45.00,0,8,0,1469957395,0),(15,1,1,4.00,'备注：4天收菜，10字好评',1,'',1,'大苹果轮胎店',250.00,0,8,0,1469957462,0),(16,1,1,4.00,'...',1,'',15,'海尔厨卫电器高端店',212.00,0,8,0,1469958066,0),(17,1,1,4.00,'备注：快递收货，五星带字好评20字以上。一定看物流 ，要及时收货，5星好评 15字好评，收货完给我截图',1,'',12,'思蓓儿旗舰店',98.00,0,8,0,1469958201,0),(18,1,1,3.00,'备注：快递收货，五星带字好评20字以上。一定看物流 ，要及时收货，5星好评 15字好评，收货完给我截图',1,'',12,'农家的老张',29.70,0,8,0,1469958256,0),(19,1,1,4.00,'备注：待收，20字以上好评',1,'',13,'郭志浩06',313.00,0,8,0,1469958353,0),(20,1,1,4.00,'备注：待收，20字以上好评',1,'',13,'zhangguanzhuo2013',280.00,0,8,0,1469958390,0),(21,1,1,4.00,'备注：到账，看物流签收了 5分好评+10字以上评语',1,'',14,'qiulingxi8988',188.00,0,8,0,1469958496,0),(22,1,1,4.00,'备注：到账，看物流签收了 5分好评+10字以上评语',1,'',14,'kelly110789',45.00,0,8,0,1469958554,0);
...
CREATE TABLE `farms_supply` (
  ...
  `vest_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '马甲格式id',
...
INSERT INTO `farms_supply` VALUES (1,1,1,273787644,0,'安达',11,714632882,'',1469524829,1469537329),(2,1,1,272672029,0,'看灰机',10,80305969,'',1469760218,0),(3,1,1,272571165,0,'小咕噜',1,2209163626,'',1469760303,1469936486),(4,1,1,275426233,0,'呱呱',2,1640209010,'',1469939637,0),(5,1,1,272218817,0,'水月',3,767266483,'',1469939672,0),(6,1,1,271276378,0,'老猫',4,29134028,'',1469939700,0),(7,1,1,283156882,0,'在路上',5,190534548,'',1469939773,0),(8,1,1,283343408,0,'紫陌',6,29134028,'',1469939804,0),(9,1,1,273489472,0,'孙哥',7,3356314685,'',1469939855,0),(10,1,1,271321529,0,'红ღ茶',8,212331904,'',1469939930,0),(11,1,1,272314687,0,'墨缘',9,3248233518,'',1469940332,0),(12,1,1,272207750,0,'邱总',13,0,'',1469940533,0),(13,1,1,272253814,0,'天靓',14,0,'',1469940563,0),(14,1,1,281439060,0,'雅雅',15,0,'',1469940610,0),(15,1,1,284761812,0,'内心',12,2928742972,'',1469958030,0);
...
CREATE TABLE `farms_vest` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `prefix` varchar(10) NOT NULL COMMENT '马甲前缀',
  `tuan` varchar(10) NOT NULL COMMENT '团名称',
  `suffix` varchar(10) NOT NULL COMMENT '马甲后缀',
  `remark` varchar(10) NOT NULL COMMENT '备注信息',
  `created_at` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `updated_at` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='马甲格式 farms_vests';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `farms_vest` VALUES (1,'ＶＸ♔','５团❤','主持','',1470010781,1470011059),(2,'ＶＸ丶','４６㊣','主持','',1470011285,0),(3,'ＶＸ♔','６８㊣','主持','',1470011320,0),(4,'ＶＸ♔','６６.','主持','',1470011340,0),(5,'ＶＸ♔','40团','主持','',1470011387,0),(6,'ＶＸ♔','12S·','主持','',1470011409,0),(7,'ＶＸ♔','Ａ５㊣','主持','',1470011431,0),(8,'ＶＸ♔','零Ｂ.','主管','',1470011737,0),(9,'ＶＸ❤','Y区','主持','',1470011932,0),(10,'ＶＸ❤','１１㊣','主持','龍魂',1470011988,0),(11,'ＶＸ丶','１１㊣','主持','',1470012418,0),(12,'ＶＸ❤','04㊣','主持','广东',1470013050,0),(13,'ＶＸ♔','28.','主播','',1470013085,0),(14,'ＶＸ♔','５Ｅ','主持','',1470013117,0),(15,'丿龍魂丶','２H㊣','主持','',1470013151,0);
...
INSERT INTO `users` VALUES (1,'九哥','九哥','$2y$10$reh/Cff/tf3W8k5Jr9FfY.sG2BUS1iq/wuS29FXHVNibbSNDCcsOu','a12345','','','',0,0,0,0,0,0,'',1469265270,0,1470039837);
...
CREATE TABLE `users_log` (
  ...
  `logoutTime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '登出时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='用户日志表 users_log';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users_log` VALUES (1,1,1469536954,0),(2,1,1469578200,0),(3,1,1469586646,0),(4,1,1469608093,0),(5,1,1469661718,0),(6,1,1469677778,0),(7,1,1469691583,0),(8,1,1469702489,0),(9,1,1469751731,0),(10,1,1469835881,0),(11,1,1469926196,0),(12,1,1469935788,0),(13,1,1469954513,0),(14,1,1470015129,0),(15,1,1470039837,0);
...
-- Dump completed on 2016-08-01 18:05:24
